...
# -*- encoding: utf-8 -*-
# stub: nsq-cluster 0.2.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rspec-rainbow>, ["~> 0.1.0"])
      s.add_development_dependency(%q<rspec-legacy_formatters>, ["~> 1.0.0"])
    else
      s.add_dependency(%q<fakeweb>, ["~> 1.3.0"])
      s.add_dependency(%q<jeweler>, ["~> 2.0.1"])
      s.add_dependency(%q<rspec>, ["~> 3.0.0"])
      s.add_dependency(%q<rspec-rainbow>, ["~> 0.1.0"])
      s.add_dependency(%q<rspec-legacy_formatters>, ["~> 1.0.0"])
    end
  else
    s.add_dependency(%q<fakeweb>, ["~> 1.3.0"])
    s.add_dependency(%q<jeweler>, ["~> 2.0.1"])
